...
from safari.src.utils import permutations

from safari.src.dataloaders.base import default_data_path, ImageResolutionSequenceDataset, ResolutionSequenceDataset, SequenceDataset
...
class SpeechCommands(ResolutionSequenceDataset):
    ...
    def setup(self):
        ...
        from safari.src.dataloaders.datasets.sc import _SpeechCommands
